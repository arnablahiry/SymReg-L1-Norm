...
MAX_LENGTH = 40   # was 200 — 3 vars, expected 6-15 node expressions; 40 is generous headroom
...
# → LENGTH_LOC = 10   # was 100 — your own comment says 8-15 for this problem : very permissive, SR can explore complex expressions freely.
# → For cosmology L1-norm (expected power-law ~5-15 nodes), try LENGTH_LOC = 8–15.
LENGTH_LOC = 10   # was 100 — your own comment says 8-15 for this problem
...
LENGTH_SCALE = 5  # was 50 — tighter enforcement around LENGTH_LOC=10
...
free_const_opti_args = {
    ...
    'method_args': {
        ...
        'n_steps' : 50,  # was 20 — PC scores can have flatter constant landscapes
